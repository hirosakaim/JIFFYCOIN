...
// Copyright (c) 2013 JiffyCoin developers
...
const string strMessageMagic = "JiffyCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
  //  int64 nSubsidy = nStartSubsidy;
    ...
    if (nHeight == 1) {nSubsidy = 420000 * COIN;}
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("JiffyCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("JiffyCoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running JiffyCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("JiffyCoinMiner terminated\n");
        throw;
    }
}
