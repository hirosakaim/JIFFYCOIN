...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QStringLiteral("Copyright &copy; 2009-YYYY The Bitcoin developers"));
        ...
        copyrightLabel2->setText(QStringLiteral("Copyright &copy; 2013 The JiffyCoin Team"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About JiffyCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>JiffyCoin</b> version", 0));
